  ...
  factory ServerFailure.fromDioException(DioException dioError) {
    switch (dioError.type) {
      ...
      case DioExceptionType.sendTimeout:
        return ServerFailure("Send timeout. Please check your network and try again.");

      case DioExceptionType.receiveTimeout:
        return ServerFailure("Receive timeout. Unable to get a response from the server.");

      case DioExceptionType.badCertificate:
        return ServerFailure("Bad certificate. The server's certificate is not trusted.");
